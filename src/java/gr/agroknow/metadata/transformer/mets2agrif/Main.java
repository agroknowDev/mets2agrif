package gr.agroknow.metadata.transformer.mets2agrif;
...
public class Main 
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		{
			System.err.println( "Usage : java -jar mets2agrif.jar -input <INPUT_FOLDER> -output <OUTPUT_FOLDER> -bad <BAD_FOLDER> -set <SET_NAME> [-manifestation <MANIFESTATION_NAME>] [-mtdLanguage <METADATA_LANGUAGE>] [-potentialLanguages <LANG1,LANG2,LANGn>]" ) ;
			System.exit( -1 ) ;
		}
		
		METS2AGRIF transformer = null ;
		String identifier ;
