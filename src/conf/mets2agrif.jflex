...
<YYINITIAL>
{
	...
	"<mods"|"<mods:mods"|"<mdWrap MDTYPE=\"MODS\">"
	{
		agrifs = new ArrayList<Agrif>() ;
		init() ;
		yybegin( AGRIF ) ;
...
<AGRIF>
{
	...
	"<titleInfo>".+"</titleInfo>"|"<mods:titleInfo>".+"</mods:titleInfo>"
	{
    ...
    "<name type=\"personal\">"|"<mods:name type=\"personal\">"|"<name type=\"personal\"".+">"|"<mods:name type=\"personal\"".+">"|"<mods:name>"
    {
    	yybegin( CREATOR ) ;
    	creator = new Creator() ;
